...
js_content = '''// ClipForge Web Interface
class ClipForgeApp {
    constructor() {
    ...
    setupSettings() {
        ...
        // Toggles
        const toggles = ['ap-enabled', 'mirror', 'add-border', 'audio-pitch'];
        toggles.forEach(id => {
...
with open('/workspace/clipforge-web/static/app.js', 'w', encoding='utf-8') as f:
    f.write(js_content)
